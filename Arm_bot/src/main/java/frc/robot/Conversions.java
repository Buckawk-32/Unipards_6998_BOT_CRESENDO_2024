...
public class Conversions {
    ...
    public static double RPS_to_MPS (double WHEEL_RPS, double CIRCUMFERENCE) {
        double WHEEL_MPS = WHEEL_RPS * CIRCUMFERENCE;
        return WHEEL_MPS;
    }

//    public static double MPS_to_RPS (double WHEEL_MPS, double CIRCUMFERENCE) {
//        double
//    }
