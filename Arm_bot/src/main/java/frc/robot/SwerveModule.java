...
public class SwerveModule{
    ...
    private final PIDController ANGLE_PID = new PIDController(Swerve_Type_Constants.SDS_MK4i_L1().ANGLE_KP, Swerve_Type_Constants.SDS_MK4i_L1().ANGLE_KI, Swerve_Type_Constants.SDS_MK4i_L1().ANGLE_KD);
    ...
    private final SimpleMotorFeedforward ANGLE_FEEDFORWARD = new SimpleMotorFeedforward(0, 1.8, 0);
    ...
    private void setAngle(SwerveModuleState DESIRED_STATE) {
        ANGLE_MOTOR.setControl(ANGLE_POSITION.withPosition(DESIRED_STATE.angle.getRotations()));
    }
    ...
    public SwerveModulePosition getPosition() {
        return new SwerveModulePosition(
                ...
                Rotation2d.fromRotations(ANGLE_MOTOR.getPosition().getValue())
        );
    }
    ...
    public void reset_to_Absolute_0() {
        double ABSOLUTE_ANGLE = (getCANcoder().getRotations() - ANGLE_OFFSET.getRotations());
        ANGLE_MOTOR.setPosition(ABSOLUTE_ANGLE);
    }
    ...
    private void config_angle_motor() {
        ...
        A_MOTOR_CONFIG.Slot0.kS = 0;
        A_MOTOR_CONFIG.Slot0.kV = 0;
        A_MOTOR_CONFIG.Slot0.kA = 0;
        ...
        A_MOTOR_CONFIG.MotorOutput.NeutralMode = Swerve_Motion_Constants.SWERVE_ANGLE_MOTOR_CONSTANTS.SWERVE_ANGLE_NEUTRAL_MODE;
        A_MOTOR_CONFIG.MotorOutput.Inverted = swerveTypeConstants.ANGLE_MOTOR_INVERT;
