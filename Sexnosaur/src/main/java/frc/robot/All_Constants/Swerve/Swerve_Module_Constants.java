...
public class Swerve_Module_Constants {
    ...
    public static class FRONT_LEFT {
        ...
        public final static int FRONT_LEFT_ANGLE_MOTOR_ID = 1;
    ...
    public static class BACK_LEFT {
        public final static int BACK_LEFT_DRIVE_MOTOR_ID = 2;
        public final static int BACK_LEFT_ANGLE_MOTOR_ID = 2;
    ...
    public static class BACK_RIGHT {
        public final static int BACK_RIGHT_DRIVE_MOTOR_ID = 3;
        public final static int BACK_RIGHT_ANGLE_MOTOR_ID = 3;
    ...
    public static class FRONT_RIGHT {
        public final static int FRONT_RIGHT_DRIVE_MOTOR_ID = 4;
        public final static int FRONT_RIGHT_ANGLE_MOTOR_ID = 4;
    ...
    public static class LIMELIGHT_CONSTANTS {
        public final static String LIMELIGHT_NAME = "bitch";
    }
}
