...
public class Swerve_Motion_Constants {
    ...
    public static final class SWERVE_ANGLE_MOTOR_CONSTANTS {
        ...
        public static final CANSparkBase.IdleMode SWERVE_ANGLE_NEUTRAL_MODE = CANSparkBase.IdleMode.kCoast;

        public static final double SWERVE_ANGLE_OPENLOOPRAMP = 0.25;
        public static final double SWERVE_ANGLE_CLOSEDLOOPRAMP = 0.0;
    }

    public static final class SWERVE_VISION_CONSTANTS {
        ...
        public static final double VISION_AIM_TOLERANCE = 0.0;
        public static final double VISION_AIM_INTEGRATION_RANGE = 0.5;
    }
}
